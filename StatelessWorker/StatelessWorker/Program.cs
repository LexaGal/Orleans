...
namespace DirProcClientHost
{
    public class Program
    {
                ...
                try
                {
                    client = new ClientBuilder()
                        ...
                        .ConfigureApplicationParts(parts =>
                            parts.AddApplicationPart(typeof(IDirProcessor).Assembly).WithReferences())
        ...
        private static async Task ProcessorDirFiles(IClusterClient client)
        {
            ...
            var dirProcessor = client.GetGrain<IDirProcessor>(Consts.DirProcGuid);
            await dirProcessor.SetupDirProcessor(inDir);
            await dirProcessor.StartProcessDir();
        }
    }
}
